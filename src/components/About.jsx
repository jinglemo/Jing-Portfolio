  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      ...
      className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card">
        ...
        className="bg-[#915EFF] rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col">
  ...
  return (
    <>
      ...
      className="mt-4 text-secondary text-[]17px max-w-3xl leading-[30px]">
        ...
        solutions. Clients can expect me to be adaptable to the needs of any
        project or team, with strong problem-solving skills that allow me to
